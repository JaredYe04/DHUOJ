...
public interface OJWS {
	...
	public String wsLogin_Judge(String account, String userPassword);

	// 将考试列表转换成xml格式
	public String wsGetExamList(String userName, String password);

	// 将考试列表转换成xml格式
	public String wsGetExamListByPMAdminuser(String userName, String password);

	// 通过Id将考试列表转换成xml格式
	public String wsGetExamById(String userName, String password, int examId);

	public byte[] wsExportExamInfo(String account, String password, Integer examId);
	...
	public String wsGetExamDetail(String userName, String password, int examId);
      ...
      // 获取排名信息
      public String wsGetExamRank(String userName, String password, int examId);

	// 根据用户提交的代码对WrongCases,Solution,Problems,StudentExamDetail的相关信息,返回solutionId
//	public String wsSubmitCode(String userName, String password,int classId, String codeXml);

	public String wsSubmitCode(String userName, String password, String codeXml, String examId);
	...
	// 获取截至时间
    Long wsGetExamDeadline(String userName, String password, int examId);
	...
	//智能训练模块"提交代码"操作
	public String wsItrainSubmitCode(String userName, String password,int classId,int catId,String codeXml);
